...
//   documentScanSdk.openScanner(scannerId, (error, handle) => {
...
//   await documentScanSdk.startScan(scannerHandle);
//   document
//     .getElementById("scanSatusDiv")
...
//   try {
//     await documentScanSdk.closeScanner(scannerHandle);
...
// const onRefresh = () => {
//   documentScanSdk.getScannersList({}).then((scanners) => {
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  documentScanSdk.renderDefaultUI(container);
});
